...
const allowedStates = new Set(['PLANNED','READY','CONTRACT_IN_PROGRESS','CONTRACT_READY','BACKEND_IN_PROGRESS','BACKEND_IMPLEMENTED','FRONTEND_IN_PROGRESS','FRONTEND_IMPLEMENTED','QA_IN_PROGRESS','REVIEW_IN_PROGRESS','REVISION_IN_PROGRESS','PASSED','DONE','BLOCKED']);
...
function validateDto(dto, rel, { expectedWorkOrderId, expectedModule } = {}) {
  ...
  const behaviorStates = new Set(['BACKEND_IMPLEMENTED','FRONTEND_IMPLEMENTED','QA_IN_PROGRESS','REVIEW_IN_PROGRESS','REVISION_IN_PROGRESS','PASSED','DONE']);
