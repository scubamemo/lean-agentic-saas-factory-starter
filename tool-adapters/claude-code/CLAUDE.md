...
Read this file first, then immediately load `AGENTS.md`. Use specialized subagents only when the active work order routes to a matching `.agents/skills/*/SKILL.md`.
